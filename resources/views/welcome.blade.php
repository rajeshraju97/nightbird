...
@section('content')
                ...
                <div class="col-md-12">
                    ...
                    <div class="category-carousel swiper">
                        <div class="swiper-wrapper">
                            @php
                                $categories = [
                                    ['title' => 'Fruits & Veges', 'icon' => 'icon-vegetables-broccoli.png'],
                                    ['title' => 'Breads & Sweets', 'icon' => 'icon-bread-baguette.png'],
                                    ['title' => 'Soft Drinks', 'icon' => 'icon-soft-drinks-bottle.png'],
                                    ['title' => 'Wine & Spirits', 'icon' => 'icon-wine-glass-bottle.png'],
                                    ['title' => 'Meat & Poultry', 'icon' => 'icon-animal-products-drumsticks.png'],
                                    ['title' => 'Bakery & Flour', 'icon' => 'icon-bread-herb-flour.png'],
                                ];
                            @endphp

                            @foreach($categories as $category)
                                <a href="#" class="nav-link category-item swiper-slide">
                                    <img src="{{ asset('images/' . $category['icon']) }}" alt="{{ $category['title'] }}">
                                    <h3 class="category-title">{{ $category['title'] }}</h3>
                                </a>
                            @endforeach

                            {{-- Repeat some for demo --}}
                            @for($i = 0; $i < 6; $i++)
                                <a href="#" class="nav-link category-item swiper-slide">
                                    <img src="{{ asset('images/icon-vegetables-broccoli.png') }}" alt="Fruits & Veges">
                ...
                <div class="col-md-12">
                    <div class="brand-carousel swiper">
                        <div class="swiper-wrapper">
                            ...
                            @foreach ($brands as $brandImage)
                                <div class="swiper-slide">
                                    <div class="card mb-3 p-3 rounded-4 shadow border-0">
                                        <div class="row g-0">
                                            <div class="col-md-4">
                                                <img src="{{ asset('images/' . $brandImage) }}" class="img-fluid rounded"
                                                    alt="Brand Image">
                                            </div>
                                            <div class="col-md-8">
                                            ...
                                            <div class="product-item">
                                                ...
                                                <figure>
                                                    <a href="#" title="Product Title">
                                                        <img src="{{ asset('images/' . $img) }}" class="tab-image"
                                                            alt="Product Image">
                                                    </a>
                                                </figure>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="#"><img src="{{ asset('images/thumb-cucumber.png') }}"
                                                        class="tab-image" alt=""></a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                            <span class="qty">1 Unit</span>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="input-group product-qty">
                                                    <span class="input-group-btn">
                                                        <button type="button"
                                                            class="quantity-left-minus btn btn-danger btn-number"><svg
                                                                width="16" height="16">
                                                                <use xlink:href="#minus"></use>
                                                            </svg></button>
                                                    </span>
                                                    ...
                                                    <span class="input-group-btn">
                                                        <button type="button"
                                                            class="quantity-right-plus btn btn-success btn-number"><svg
                                                                width="16" height="16">
                                                                <use xlink:href="#plus"></use>
                                                            </svg></button>
                                                    </span>
                                ...
                                <div
                                    ...
                                    <div class="col">
                                        <div class="product-item">
                                            ...
                                            <figure>
                                                <a href="#"><img src="{{ asset('images/thumb-orange-juice.png') }}"
                                                        class="tab-image" alt=""></a>
                                            </figure>
                                            <h3>Sunstar Fresh Melon Juice</h3>
                                            <span class="qty">1 Unit</span>
                ...
                <div class="col-md-12">
                    ...
                    <div class="products-carousel swiper">
                        <div class="swiper-wrapper">
                            ...
                            @foreach ($bestSellingProducts as $productImage)
                                <div class="product-item swiper-slide">
                                    ...
                                    <figure>
                                        <a href="#" title="Product Title">
                                            <img src="{{ asset('images/' . $productImage) }}" class="tab-image" alt="Product">
                                        </a>
                                    </figure>
                                    <h3>Sunstar Fresh Melon Juice</h3>
                                    <span class="qty">1 Unit</span>
            ...
            <div class="bg-secondary py-5 my-5 rounded-5"
                ...
                <div class="container my-5">
                    <div class="row">
                        ...
                        {{-- Form --}}
                        <div class="col-md-6 p-5">
                            <form method="POST" action="{{ route('discount.subscribe') }}">
                                @csrf
                                <div class="mb-3">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="products-carousel swiper">
                        <div class="swiper-wrapper">
                            @foreach (['tomatoes', 'tomatoketchup', 'bananas', 'bananas', 'tomatoes', 'tomatoketchup', 'bananas', 'bananas'] as $image)
                                <div class="product-item swiper-slide">
                                    <a href="#" class="btn-wishlist">
                                        <svg width="24" height="24">
                                            <use xlink:href="#heart"></use>
                                    ...
                                    <figure>
                                        <a href="#" title="Product Title">
                                            <img src="{{ asset('images/thumb-' . $image . '.png') }}" class="tab-image"
                                                alt="Product">
                                        </a>
                                    </figure>
                                    <h3>Sunstar Fresh Melon Juice</h3>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="products-carousel swiper">
                        <div class="swiper-wrapper">
                            @foreach (['tomatoes', 'tomatoketchup', 'bananas', 'bananas', 'tomatoes', 'tomatoketchup', 'bananas', 'bananas'] as $item)
                                <div class="product-item swiper-slide">
                                    <a href="#" class="btn-wishlist">
                                        <svg width="24" height="24">
                                            <use xlink:href="#heart"></use>
                                    ...
                                    <figure>
                                        <a href="#" title="Product Title">
                                            <img src="{{ asset('images/thumb-' . $item . '.png') }}" class="tab-image"
                                                alt="Product">
                                        </a>
                                    </figure>
                                    <h3>Sunstar Fresh Melon Juice</h3>
                    ...
                    <div class="col-md-4">
                        <article class="post-item card border-0 shadow-sm p-3">
                            <div class="image-holder zoom-effect">
                                <a href="#">
                                    <img src="{{ asset('images/' . $blog['image']) }}" alt="post" class="card-img-top">
                                </a>
                            </div>
                            <div class="card-body">
    ...
    {{-- FoodMart App Download Section --}}
    <section class="py-5 my-5">
        <div class="container-fluid">

            <div class="bg-warning py-5 rounded-5"
                style="background-image: url('{{ asset('images/bg-pattern-2.png') }}'); background-repeat: no-repeat;">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-8">
                            ...
                            <p>
                                ...
                                non et psryroin.
                                Amet sed lorem posuere sit iaculis amet, ac urna. Adipiscing fames semper erat ac in
                                suspendisse iaculis.
                                Amet blandit tortor praesent ante vitae. A, enim pretiummi senectus magna. Sagittis sed
                                ptibus liberolectus non et psryroin.
                            </p>
    ...
    <section class="py-5">
        <div class="container-fluid">
            ...
            @foreach ($tags as $tag)
                <a href="#" class="btn btn-warning me-2 mb-2">{{ $tag }}</a>
            @endforeach
